...
#include "DMA.h"   
extern int Voltage;                                                      
extern int Usart_Receive,Usart2_Receive;
extern int Encoder_A,Encoder_B;               
extern int Motor_A; 
extern float Velocity_KP,Velocity_KI;
extern float Position_KP ,Position_KI ,Position_KD ;
extern int Position_A,Position_target,Velocity_target;
extern u8 Start_Flag,MODE_Flag; 

extern u8 FLAG_USART,data1_top[55], sum,i_u;
extern u8 send_buf[54];
