...
void Encoder_TIM2_Init(void)
{
  ...
  TIM_TimeBaseInitStruct.TIM_Period = Encode_TIM2_PERIOD;                      // 重装载值65535
  TIM_TimeBaseInitStruct.TIM_Prescaler = Encode_TIM2_PSC;                        // 分频系数0
...
void Encoder_TIM4_Init(void)
{
  ...
  TIM_TimeBaseInitStruct.TIM_ClockDivision = TIM_CKD_DIV1;      // 不分频
  TIM_TimeBaseInitStruct.TIM_CounterMode = TIM_CounterMode_Up;  // 向上计数
  TIM_TimeBaseInitStruct.TIM_Period = Encode_TIM4_PERIOD;                    // 重装载值65535
  TIM_TimeBaseInitStruct.TIM_Prescaler = Encode_TIM4_PSC;                     // 分频系数0
